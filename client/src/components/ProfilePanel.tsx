    ...
    <div className={'profile-panel'}>
      ...
      <div className={'profile-panel-hover'} onClick={() => navigate(profileURL)}>
        <div className={'profile-panel-hover-item'}>
          <ThemeIcon 
            light={'assets/white/role.png'}
            dark={'assets/black/role.png'}
          />
          <p>{profileData.job_title}</p>
          </div>
        <div className={'profile-panel-hover-item'}>
          <ThemeIcon 
            light={'assets/white/location.png'}
            dark={'assets/black/location.png'}
          />
          <p>{profileData.location}</p>
          </div>
        <div className={'profile-panel-hover-item'}>
          <ThemeIcon 
            light={'assets/white/pronouns.png'}
            dark={'assets/black/pronouns.png'}
          />
          <p>{profileData.pronouns}</p>
          </div>
        <div className={'profile-panel-hover-item'}>
          <ThemeIcon 
            light={'assets/white/funfact.png'}
            dark={'assets/black/funfact.png'}
          />
