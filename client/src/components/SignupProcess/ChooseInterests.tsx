...
//
const ChooseInterests = ({ show, onNext, onBack, selectedInterests, setSelectedInterests, mode, onClose }) => {
                ...
                <div className="ChooseInterests">
                    ...
                    {mode === "signup" ? (
                        ...
                        <>
                            ...
                            <h1 id="signupProcess-title">Edit Preferences/Project Interests
                                <p>Add interests using the search bar, then select 3 or 4 interests to be highlighted on your profile</p>
                            </h1>
                        </>
                    )}
                    ...
                    <div id='signupProcess-btns'>
                        {mode === "signup" ? (
                            ...
                            <>
                                ...
                                <button
                                    id="signup-nextBtn"
                                    onClick={() => { setSelectedInterests([]); onClose(); }}
                                    // disable the next button if the user has not selected at least 3 interests
                                    // this is to prevent the user from moving to the next modal without selecting the required number of interests
                                    // the user can only move to the next modal when they have selected at least 3 interests
                                    disabled={selectedInterests.length < 3}
