  ...
  return (
    <div id='project-info'>
      ...
      <div id='project-header'>
        ...
        <div id='project-member-count'>{projectPageHelper.createMemberCount(props.projectData)}</div>
      ...
      <div id='project-listings'>
        ...
        <button id='interested-button' className='white-button' onClick={projectPageHelper.addInterested}>Interested</button>
      </div>
    </div>
  )
}