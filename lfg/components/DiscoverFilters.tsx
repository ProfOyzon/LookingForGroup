...
export const DiscoverFilters = ({ category, updateItemList }) => {
   ...
   const resizeTagFilter = () => {
      ...
      if (scrollAmt >= tagFilterElement.scrollWidth && !rightScroll.classList.contains("hide")) {
         ...
         scrollAmt < tagFilterElement.scrollWidth &&
         rightScroll.classList.contains("hide")
      ) {
         rightScroll.classList.remove("hide");
      }
   };
                                    ...
                                    <button
                                       ...
                                       onClick={(e) => {
                                          ...
                                          if (selecIndex === -1) {
                                             ...
                                             setEnabledFilters(
                                                enabledFilters.toSpliced(selecIndex, 1)
                                             );
                                             element.classList.replace(
                                                `tag-button-${searchedTags.color}-selected`,
                                                `tag-button-${searchedTags.color}-unselected`
                              ...
                              {enabledFilters.map((tag) => (
                                 <button
                                    ...
                                    onClick={(e) => {
                                       ...
                                       setEnabledFilters(
                                          enabledFilters.toSpliced(
                                             isTagEnabled(tag.tag, tag.color),
                                             1
                                          )
                                       );
                                    }}
                        ...
                        <PopupButton
                           ...
                           callback={() => {
                              ...
                              const discoverFilters =
                                 document.getElementsByClassName("discover-tag-filter");
                              ...
                              for (let i = 0; i < enabledFilters.length; i++) {
                                 ...
                                 for (let j = 0; j < discoverFilters.length; j++) {
                                    if (
                                       ...
                                       discoverFilters[j].classList.add(
