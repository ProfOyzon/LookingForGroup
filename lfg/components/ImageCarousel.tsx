                  ...
                  <div id="project-image-carousel-buttons">
                     ...
                     <div id="carousel-tabs">
                        {dataList.map((image, index) => {
                           let className =
                              index === currentIndex
                                 ? "carousel-tab carousel-tab-active"
                                 : "carousel-tab";
                           return (
                              <button
                                 className={className}
                        ...
                        {dataList.map((image, index) => (
                           ...
                           >
                              ...
                              <div className="discover-carousel-description">
                                 ...
                                 elit. Cumque, quidem? Fugit deleniti reiciendis doloremque
                                 assumenda neque rem repudiandae hic odit quaerat. Debitis dicta
                                 fugit expedita, quaerat autem animi quia voluptatum quam magni
                                 minus ducimus, aliquam obcaecati numquam. Quisquam similique
                                 laudantium doloremque pariatur expedita dicta suscipit eligendi
                                 molestiae, harum iusto sequi.
                              </div>
                           </div>
                        ))}
                     </div>
