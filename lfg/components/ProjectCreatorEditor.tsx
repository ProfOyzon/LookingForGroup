...
export const ProjectCreatorEditor = () => {
   ...
   const isTagSelected = useCallback(
      (tab: number, id: number, label: string) => {
         // Project Type
         if (tab === 0) {
            return modifiedProject.project_types.some(
               (t) => t.id === id && t.project_type === label
            )
               ? "selected"
               : "unselected";
         }
   ...
   const saveProject = async () => {
      ...
      try {
         console.log(
            `Sending PUT request to /api/projects/${projectID} for body: `,
            modifiedProject
         );
            ...
            <div id="project-editor-general">
               ...
               <div id="project-editor-status-input" className="project-editor-input-item">
                  ...
                  >
                     ...
                     {statusOptions.map((o) => (
                        <option selected={newProject ? false : modifiedProject.status === o}>
                           {o}
                        </option>
                     ))}
                  </select>
               ...
               <div id="project-editor-purpose-input" className="project-editor-input-item">
                  ...
                  >
                     ...
                     {purposeOptions.map((o) => (
                        <option selected={newProject ? false : modifiedProject.purpose === o}>
                           {o}
                        </option>
                     ))}
                  </select>
               ...
               <div id="project-editor-audience-input" className="project-editor-input-item">
                  ...
                  <div className="project-editor-extra-info">
                     Define who this project is intended for--consider age group, interest,
                     industry, or specific user needs.
                  </div>
               ...
               >
                  ...
                  <div className="project-editor-extra-info">
                     ...
                     inspirations and goals, outline key features, and describe this impact you hope
                     it brings to others.
                  </div>
                  <span className="character-count">
            ...
            <div id="project-editor-media">
               ...
               <div id="project-editor-image-ui">
                  ...
                  <div id="project-editor-add-image">
                     ...
                     <div className="project-editor-extra-info">
                        Drop your image here, or {/*TODO: click to upload file<input type="file">*/}
                        browse
                        {/*</input>*/}
                     </div>
                  ...
                  <div id="edit-position-details-left">
                     ...
                     >
                        ...
                        {availabilityOptions.map((o) => (
                           <option
                              key={o}
                              selected={
                                 newPosition ? false : getProjectJob(currentRole).availability === o
                              }
                           >
                              {o}
                           </option>
                     ...
                     >
                        ...
                        {locationOptions.map((o) => (
                           <option
                              selected={
                                 newPosition ? false : getProjectJob(currentRole).location === o
                              }
                           >
                              {o}
                           </option>
                  ...
                  <div id="edit-position-details-right">
                     ...
                     >
                        ...
                        {durationOptions.map((o) => (
                           <option
                              selected={
                                 newPosition ? false : getProjectJob(currentRole).duration === o
                              }
                           >
                              {o}
                           </option>
                     ...
                     >
                        ...
                        {compensationOptions.map((o) => (
                           <option
                              selected={
                                 newPosition ? false : getProjectJob(currentRole).compensation === o
                              }
                           >
                              {o}
                           </option>
                              ...
                              <div id="project-team-add-member-role">
                                 ...
                                 >
                                    {allJobs.map((job: { title_id: number; label: string }) => (
                                       <option
                                          key={job.title_id}
                                          selected={job.label === m.job_title}
                                       >
                                          {job.label}
                                       </option>
                                    ))}
               ...
               <div id="project-team-open-positions-popup">
                  <div className="positions-popup-list">
                     ...
                     <div id="team-positions-popup-list-buttons">
                        {modifiedProject.jobs.map(
                           (job: { job_title: string; title_id: number }) => (
