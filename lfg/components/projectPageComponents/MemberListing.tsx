...
export const MemberListing = (props) => {
   ...
   return (
      <div className="member-settings-listing">
         ...
         <img
            className="member-settings-profile"
         ...
         <input
            className="member-settings-role-input"
            type="text"
         ...
         <div id={"member-settings-dropdown-" + props.idNum} className="settings-hide">
            <button
               ...
               onClick={() => props.updateMemberSettings(1, props.idNum)}
            >
               Add/Remove Admin Role
            </button>
            <button
               className="white-button"
               onClick={() => props.updateMemberSettings(2, props.idNum)}
            >
