   ...
   return (
      <>
         ...
         <div id={"role-list-" + props.num} className="role-list-info">
            ...
            <input
               type="text"
               className="role-list-name-edit-hide"
               defaultValue={props.role.Role}
            />
            <span className="role-list-num">{props.role.amount}</span>
            <input
               type="number"
               className="role-list-num-edit-hide"
               defaultValue={props.role.amount}
            />
            <button
               className="role-list-desc-dropdown"
               onClick={() => toggleDescription(props.num)}
            >
               V
            </button>
