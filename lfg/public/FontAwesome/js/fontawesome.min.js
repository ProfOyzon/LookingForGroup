...
!(function () {
   ...
   function ie(t) {
      ...
      m =
         p && !~f.classes.indexOf("fa-fw") ? { width: "".concat((m / d) * 16 * 0.0625, "em") } : {};
      u && (h.attributes[C] = ""),
         s &&
            (h.children.push({
               tag: "title",
      ...
      nest: function (t) {
         ...
         if ((delete a[0].attributes.id, a[0].attributes.class)) {
            const r = a[0].attributes.class
               ...
               .reduce(
                  (t, e) => (
                     (e === et.replacementClass || e.match(n) ? t.toSvg : t.toNode).push(e), t
                  ),
                  { toNode: [], toSvg: [] }
               );
               ...
               t.generateAbstractMask = function (t) {
                  ...
                  var { width: l, icon: f } = r,
                     ...
                     l = {
                        ...
                        attributes: { ...u.inner },
                        children: [
                           qe({ tag: c.tag, attributes: { ...c.attributes, ...u.path }, ...t })
                        ]
                     },
                     ...
                     return (
                        ...
                        i ||
                           t.push({
                              ...
                              children: [
                                 { tag: "animate", attributes: { ...n, values: "0;0;1;1;0;0;" } }
                              ]
                           }),
